...
import defaultClasses from './BestSellers.css';
...
class BestSellers extends Component {
    ...
    render(){
        const { bestSellersWrapper, bestSellersSlider, items, productName, priceWrapper, productPrice, btnNow  } = defaultClasses;
        const settings = {
            dots: false,
            infinite: true,
            speed: 500,
...
export default classify({})(BestSellers);